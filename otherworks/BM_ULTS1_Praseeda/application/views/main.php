...
<form class="formsignup" method="POST" action=<?php echo base_url()."index.php/Logincontroller/signin";?>>
	...
	<p align="center" class="txt4">It's free and always will be.</p>
		...
		<input type="text" name="lname" placeholder="LastName" class="txtlname">
<label id='error1'>
		<?php 
		...
		<br><br>
		<input type="text" name="mobile" placeholder="Mobile Number" class="txtm" minlength="10" maxlength="10">
		<label id='error3'>
		<?php 
		if(isset($mobile))
		{
		...
		?></label><br><br>
		<input type="text" name="email" placeholder="Email" class="txtm">
		<label id='error4'>
		<?php 
		...
		?></label><br><br>
		<input type="password" name="password" placeholder="Password" class="txtm" >
		<label id='error5'>
		<?php 
		if(isset($password))
		{
		...
		<span style="font-weight: bold">GENDER :</span><input type="radio" name="gender" value="male" id="r1" >  male  <input type="radio" name="gender" value="female" id="r2">  female  
		<label id='error1'>
		<?php 
		if(isset($gender))
		{
